...
await Deno.writeFile('ex1-1.png', png_rgba(1, 4)(ex1))

// write ex1 to 2x2 picture
await Deno.writeFile('ex1-2.png', png_rgba(2, 2)(ex1))

// write ex2 to 255x255 picture
// note that it must be flattened twice b/c its a 3d array
await Deno.writeFile('ex2.png', png_rgba(255, 255)(ex2.flat(2)))